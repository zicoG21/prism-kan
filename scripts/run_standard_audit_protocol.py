...
DEFAULT_ROWS = [
    ...
    {
        "label": "lowdim_c010_d20_n1024",
        "protocol": "same_training_set_bootstrap",
        "metric": "endpoint_retention",
        "successes": 0,
        "trials": 8,
        "notes": "low-/moderate-dimensional phase-grid coverage map; feature-edge readout, m=4",
    },
    {
        "label": "lowdim_c010_d20_n1024",
        "protocol": "same_training_set_bootstrap",
    ...
    {
        "label": "lowdim_width_c025_d100_n512_w16",
        "protocol": "same_training_set_bootstrap",
        "metric": "endpoint_retention",
        "successes": 8,
        "trials": 8,
        "notes": "low-dimensional width check; feature-edge readout, m=4",
    },
    {
        "label": "semisynth_breast_cancer_c025_n384",
        "protocol": "semi_synthetic_real_covariates",
        "metric": "top1_pair",
        "successes": 10,
        "trials": 10,
        "notes": "feature-edge pyKAN readout on injected formula over real covariates",
    },
    {
        "label": "semisynth_breast_cancer_c025_n384_resid",
        "protocol": "semi_synthetic_real_covariates",
        "metric": "residual_screen_top1_pair",
        "successes": 0,
        "trials": 10,
        "notes": "raw-product residual screen on injected formula over real covariates",
    },
    {
        "label": "semisynth_diabetes_c010_n128",
        "protocol": "semi_synthetic_real_covariates",
        "metric": "top1_pair",
        "successes": 6,
        "trials": 10,
        "notes": "feature-edge pyKAN readout on weakest injected interaction over real covariates",
    },
]
...
SCHEMA = {
    ...
    "protocols": {
        ...
        "semi_synthetic_real_covariates": "known formula injected into a real tabular covariate distribution",
    },
    "metrics": {
