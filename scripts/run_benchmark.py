...
def main() -> None:
    ...
    run([py, "scripts/build_reporting_protocol_simulation.py"])
    run([py, "scripts/build_overclaim_signature.py"])
    run([py, "scripts/build_expression_equivalence_subset.py"])
    run([py, "scripts/build_full_benchmark_analysis_reports.py"])
    run([py, "scripts/build_expression_track_secondary_report.py"])
    run([py, "scripts/build_literature_reporting_pattern_audit.py"])
    run([py, "scripts/build_public_hidden_split_report.py"])
    run([py, "scripts/plot_claim_transfer_graph.py"])
    run([py, "scripts/plot_overclaim_signature_heatmap.py"])
    run([py, "scripts/plot_standard_formula_signature_heatmap.py"])
